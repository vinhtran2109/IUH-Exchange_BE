...
export async function getPaymentDetails(req, res) {
  ...
  res.json(ApiResponse.ok({
    ...
    paymentIssueStatus: order.paymentIssueStatus || 'NONE',
    paymentIssueReason: order.paymentIssueReason || '',
    paymentIssueOpenedAt: order.paymentIssueOpenedAt,
    paymentIssueResolvedAt: order.paymentIssueResolvedAt,
    paymentIssueResolution: order.paymentIssueResolution || '',
    paymentIssueTimeline: order.paymentIssueTimeline || [],
