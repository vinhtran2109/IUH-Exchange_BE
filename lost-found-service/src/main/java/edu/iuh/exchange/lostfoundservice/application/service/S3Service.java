package edu.iuh.exchange.lostfoundservice.application.service;
...
public class S3Service {
    ...
    public String generatePresignedUploadUrl(String originalFilename, String contentType) {
        ...
        String objectKey = "lostfound/" + UUID.randomUUID() + extension;
    ...
    public void deleteFileByUrl(String publicUrl) {
        try {
            if (publicUrl == null || !publicUrl.contains("lostfound/")) return;
            
            String objectKey = publicUrl.substring(publicUrl.indexOf("lostfound/"));
